/*
 Congratulations! You have made our glorious Express Yourself Machine fully operational!
 Not only that, you have all the tools you need to create a basic CRUD API!
 Time to practice your skills with a new set of routes.

 You are going to add an additional set of functionality to our machine: Animal Mode!
 This will involve creating similar GET, POST, PUT and DELETE routes.
*/
